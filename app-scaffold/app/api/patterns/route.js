...
// 하면서 또 올림.
// v8 -> v9: 유아이디·에코볼트는 위 버그들과 달리 데이터 자체는 깨끗했음 —
// 다만 "전고점"이 겨우 1~4거래일 전에 막 세워진 것이라 급등 중엔 거의
// 매일 걸리는 문제가 있었음. detectBreakout에 "최소 15거래일은 버틴
// 고점이어야 인정" 하는 하드 게이트를 추가하면서 또 올림.
// v9 -> v10: 코리안리로 확인됨 — 52주 신고가를 종가 기준 최고가와
// 비교하고 있었는데, 실제 "52주 신고가"는 장중 최고가(고가) 기준이어야
// 함. 코리안리는 6월에 장중 17,560원을 찍었지만 그날 종가는 낮게
// 마감했었고, 최근 종가 상승분이 "역대 최고 종가"로 오인되어 52주
// 신고가로 잘못 잡혔음. detect52WeekHigh/Low를 고가/저가 기준으로
// 맞추면서(detectBreakout은 원래도 고가 기준이었음) 또 올림.
// v10 -> v11: v9에서 넣었던 "전고점이 최소 15거래일은 버텨야 함" 게이트를
// 재성님이 직접 예시(20일째 26,000원 돌파, 25일째 27,000원 돌파, 30일째
// 28,000원 돌파 — 간격이 며칠뿐이어도 전부 돌파로 인정)로 확인해주셔서
