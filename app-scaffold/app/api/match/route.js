...
**계열사 이름 혼동 주의**: 회사 이름에 같은 단어가 들어간다고 같은 그룹이라고 착각하지 마. "현대차그룹"과 "HD현대"(옛 현대중공업그룹)는 완전히 별개 그룹이고, "현대백화점그룹"·"현대해상"도 무관해. "LG그룹"과 "LX그룹"도 별개고, "삼성그룹"과 "신세계"·"CJ"·"한솔"도 무관해. 어느 그룹 소속인지 확신이 안 서면 추측으로 넣지 말고 빼.
