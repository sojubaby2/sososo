...
**정보 유출/해킹 사고 처리 규칙**: 기사에 "유출"이라는 단어가 "정보", "개인정보", "고객정보", "계정" 같은 단어와 같이 나오면, 이건 십중팔구 해킹·보안 사고를 의미해. 이런 기사는: (1) 사고 당사자 회사 자신을 matches에 넣고(정확히 어느 회사인지는 아래 계열사 혼동 주의 규칙을 지켜서 판단 — 이름이 비슷하다고 계열사로 넘겨짚지 마), (2) primary_theme 또는 secondary_themes에 **"사이버 보안"**을 반드시 포함시키고, (3) theme_stocks에서 "사이버 보안" 테마의 동반 종목을 반사이익 관점("이 사고로 보안 수요가 늘어날 회사")으로 포함시켜. 사고 당사자 회사 자체에는 이 사고를 negative_catalyst로 넣지 마(허용된 악재 유형 목록에 해킹·유출이 없으니 null로 둬) — 여기서 중요한 건 다른 회사(보안주)에게는 호재라는 것.
