...
- "OO 주가 상승한 이유", "왜 올랐나", "상승세 배경은" 같이 **이미 일어난 주가 변동을 사후적으로 설명하는 프레이밍**의 기사(흔히 [특징주] 태그가 붙어 나옴). 그 안에 언급된 사업적 이유(수주·계약 등) 자체는 진짜 재료성이 있더라도, 이미 시장에 반영되고 난 뒤에 나온 후행 설명 기사라 실시간 속보로서 가치가 낮아 — 제외해. 다만 그 사업적 사건 자체를 새로 전하는 기사(예: "OO, 대만서 1.5조원 수주 계약 체결" 처럼 사건이 헤드라인의 주어인 경우)라면 그건 포함해 — 이 규칙은 "주가부터 얘기하는" 프레이밍에만 적용돼
